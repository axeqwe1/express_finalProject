  ...
  db.technician.hasMany(db.notification, { foreignKey: {name:'tech_id'}})
  db.notification.belongsTo(db.employee, { foreignKey: 'emp_id', });
  db.employee.hasMany(db.notification, { foreignKey: {name:'emp_id'}})
  db.notification.belongsTo(db.admin, { foreignKey: 'admin_id', });
  db.admin.hasMany(db.notification, { foreignKey: {name:'admin_id',}})
  ...
  db.requestForRepair.hasOne(db.receiveRepair, { foreignKey: {name:'rrid',allowNull: false} })
  ...
  db.receiveRepair.hasMany(db.repairDetail,{ foreignKey: {name:'rrce_id',allowNull: false}})
  db.repairDetail.belongsTo(db.levelOfDamage,{ foreignKey: {name:'loed_id',allowNull: false}})
  db.levelOfDamage.hasMany(db.repairDetail,{ foreignKey: {name:'loed_id',allowNull: false}})
